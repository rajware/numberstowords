...
describe('Common formatted tests', () => {
  it('Should work for zero', () => {
    assertNumber(0, 'zero');
  });

  it('Should work for one through nineteen', () => {
    assertNumber(1, 'one');
    assertNumber(2, 'two');
