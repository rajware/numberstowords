...
describe('International formatted tests', () => {
  it('Should work for hundred thousands', () => {
  ...
  it('Should work for a single trillion. My eyes hurt.', () => {
