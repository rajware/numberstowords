/**
 * Type definitions for numberstowords (CommonJS)
 * Supports CommonJS require() usage
 */

/**
 * Custom error class for numberstowords operations
 */
declare class NumbersToWordsError extends Error {
 ...
 */
declare interface NumbersToWordsOpts {
  /**
 ...
 */
declare interface NumbersToWordsWords {
  /**
 ...
 */
declare interface NumbersToWords {
  /**
